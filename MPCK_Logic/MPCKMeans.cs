...
namespace Sem_Supervised_Sites_PartB
{
    ...
    class MPCKMeans
    {
        ...
        {
            //5 sites 4 words in each

            double[,] matr = new double[5, 2] { {-4,3}, {-3,4}, {2,-1}, {-3,1}, {4,-2}};

            //2 sites 4 words in each
            double[,] matr1 = new double[2, 2] { { -4, 3 }, { -3, 4 } };
            double[,] matr2 = new double[2, 2] { { 2, -1 }, { 4, -2 } };

            /*double[,] matr = new double[5, 4] { { 1, 9, 11, 3 }, { 8, 2, 4, 6 }, { 2, 3, 4, 5 }, 
            { 6, 7, 8, 9 }, { 1, 9, 5, 3 }};
            //2 sites 4 words in each
            double[,] matr1 = new double[2, 4] { { 1, 9, 11, 3 }, { 8, 2, 4, 6 } };
            double[,] matr2 = new double[2, 4] { { 2, 3, 4, 5 }, { 6, 7, 8, 9 } };*/

            //Each node of must link contains all vectors that must be together
