    ...
    class Stopwords
    {
        ...
        static void Main(string[] args)
        {
           ...
           streamReader = new StreamReader("Site2.txt");
            ...
            Console.ReadKey();
            PCA pc = new PCA(sitesFreq, 2);
            pc.compute();
            Console.WriteLine("cov value 0 0 is: " + pc.covarianceMatrix[0, 0]);
            Console.WriteLine("cov value 0 1 is: " + pc.covarianceMatrix[0, 1]);
            Console.WriteLine("cov value 1 0 is: " + pc.covarianceMatrix[1, 0]);
            Console.WriteLine("cov value 1 1 is: " + pc.covarianceMatrix[1, 1]);
            Console.WriteLine("1 eigen value is:" + pc.eigenValues[0]);
            Console.WriteLine("2 eigen value is:" + pc.eigenValues[1]);
            Console.WriteLine("eigen vector 0 is:" + pc.eigenVectors[0, 0]);
            Console.WriteLine("eigen vector 0 is:" + pc.eigenVectors[1, 0]);
            Console.WriteLine("eigen vector 0 is:" + pc.eigenVectors[2, 0]);
            Console.WriteLine("eigen vector 1 is:" + pc.eigenVectors[0, 1]);
            Console.WriteLine("eigen vector 1 is:" + pc.eigenVectors[1, 1]);
            Console.WriteLine("eigen vector 1 is:" + pc.eigenVectors[2, 1]);
            Console.WriteLine("eigen vector 2 is:" + pc.eigenVectors[0, 2]);
            Console.WriteLine("eigen vector 2 is:" + pc.eigenVectors[1, 2]);
            Console.WriteLine("eigen vector 2 is:" + pc.eigenVectors[2, 2]);
            Console.ReadKey();
        }
    }
}
